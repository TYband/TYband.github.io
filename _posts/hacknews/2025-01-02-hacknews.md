...
- [You don't need Next.js – Why we migrated from Next to React](https://www.comfydeploy.com/blog/you-dont-need-nextjs)
- 你不需要 Next.js – 我们为什么从 Next 迁移到 React
...
- [30 years ago Tomorrow's World predicted 2025 – how did it do?](https://www.bbc.com/news/articles/cjdn10yk0k1o)
...
- 彭罗斯迷宫 (2020)
- [Sea level rise is gonna get a whole lot realer](https://greenash.net.au/thoughts/2025/01/sea-level-rise-is-gonna-get-a-whole-lot-realer/)
- 海平面上升将变得更加真实
...
- 元语言编程的魔力
- [Native Distributed Databases: Problems, Challenges and Opportunities [pdf]](https://www.vldb.org/pvldb/vol17/p4217-xu.pdf)
- 原生分布式数据库：问题、挑战和机遇 [pdf]
